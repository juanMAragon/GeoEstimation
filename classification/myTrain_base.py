...
class MultiPartitioningClassifier(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        # this is the only part that needs to be changed since we will be sending single images to the data loader.
        dataset = ImageIterableDatasetMultiTargetWithDynLabels(
